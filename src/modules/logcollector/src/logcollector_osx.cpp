...
void Logcollector::AddPlatformSpecificReader(const std::shared_ptr<const configuration::ConfigurationParser> configurationParser)
{
    const auto fileWait = configurationParser->GetConfig<time_t>(
        "logcollector",
        "file_wait"
    ).value_or(
