    ...
    public:
        MOCK_METHOD(EVT_HANDLE,
                    ...
                    (HANDLE session,
                     ...
                     DWORD flags),
                    (override));
        MOCK_METHOD(BOOL, EvtRender, (EVT_HANDLE, EVT_HANDLE, DWORD, DWORD, PVOID, DWORD*, DWORD*), (override));
        ...
        EVT_HANDLE StoreCallback(
            HANDLE, HANDLE, LPCWSTR, LPCWSTR, EVT_HANDLE, PVOID context, EVT_SUBSCRIBE_CALLBACK callback, DWORD)
        {
