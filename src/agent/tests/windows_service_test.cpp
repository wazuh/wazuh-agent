...
{
public:
    MOCK_METHOD(void*, OpenSCM, (unsigned int desiredAccess), (override));
    MOCK_METHOD(void*, OpenSvc, (void* sHandle, std::string sName, unsigned int desiredAccess), (override));
    MOCK_METHOD(bool, DeleteSvc, (void* sHandle), (override));
};
