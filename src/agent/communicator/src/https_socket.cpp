...
namespace http_client
{
                              ...
                              const std::chrono::seconds timeOut)
    {
        try
        {
            ...
            {
                m_ssl_socket.handshake(boost::asio::ssl::stream_base::client, ec); // NOLINT
                if (ec)
                {
    ...
    HttpsSocket::AsyncConnect(const boost::asio::ip::tcp::resolver::results_type& endpoints, // NOLINT
    ...
    boost::asio::awaitable<void>
    HttpsSocket::AsyncWrite(const boost::beast::http::request<boost::beast::http::string_body>& req, // NOLINT
                            boost::system::error_code& ec,                                           // NOLINT
                            const std::chrono::seconds timeOut)
    {
        using namespace boost::asio::experimental::awaitable_operators;
    ...
    boost::asio::awaitable<void>
    HttpsSocket::AsyncRead(boost::beast::http::response<boost::beast::http::dynamic_body>& res, // NOLINT
                           boost::system::error_code& ec,                                       // NOLINT
                           const std::chrono::seconds timeOut)
    {
        using namespace boost::asio::experimental::awaitable_operators;
