...
void __db_msgcall __P((const DB_ENV *, const char *, va_list));
void __db_msgfile __P((const DB_ENV *, const char *, va_list));
...
int __dbt_defcmp __P((DB *, const DBT *, const DBT *, size_t *));
