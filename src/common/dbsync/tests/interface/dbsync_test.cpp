...
TEST_F(DBSyncTest, AddTableRelationshipIncorrectJSON)
{
    ...
    const std::unique_ptr<cJSON, CJsonSmartDeleter> jsAddRelationshipIncorrectJson {
        cJSON_Parse(addRelationshipIncorrectJson)};
...
{
    const auto sql {
        "CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `tid` BIGINT, PRIMARY KEY (`pid`, `tid`)) WITHOUT ROWID;"};
...
{
    const auto sql {"CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `threads` INTEGER, `cpu_usage` DOUBLE, PRIMARY "
                    "KEY (`pid`)) WITHOUT ROWID;"};
    const auto insertionSqlStmt {
        R"({"table":"processes","data":[{"pid":4,"name":"System", "threads":5, "cpu_usage":17.50}]})"};
...
{
    const auto sql {"CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `threads` INTEGER, `cpu_usage` DOUBLE, `blob` "
                    "BLOB, PRIMARY KEY (`pid`)) WITHOUT ROWID;"};
    const auto insertionSqlStmt {
        R"({"table":"processes","data":[{"pid":4,"name":"System", "threads":5, "cpu_usage":17.50, "blob":1}]})"};
...
{
    const auto sql {
        "CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `euser` TEXT, PRIMARY KEY (`pid`,`name`)) WITHOUT ROWID;"};
    const auto table {R"({"table":"processes"})"};
    auto syncSqlStmt1 = SyncRowQuery::builder()
                            .table("processes")
                            .data(nlohmann::json::parse(R"({"pid":4,"name":"System","euser":"wazuh"})"))
                            .query();
    auto syncSqlStmt2 = SyncRowQuery::builder()
                            .table("processes")
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"wazuh"})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"wazuh"})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"euser":"wazuh","name":"System","pid":4})")))
        .Times(1);
...
TEST_F(DBSyncTest, GetDeletedRowsAllAttributes)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"wazuh"})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"wazuh"})")))
        .Times(1);
...
{
    const auto sql {
        "CREATE TABLE processes(`pid` BIGINT, `name` TEXT,`path` TEXT, PRIMARY KEY (`pid`)) WITHOUT ROWID;"};
    const auto insertionSqlStmt {R"({"table":"processes","data":[{"pid":4,"name":"System"}]})"};
...
TEST_F(DBSyncTest, TryToUpdateMoreThanMaxRowsElements)
{
    const auto sql {"CREATE TABLE processes(`pid` BIGINT, `name` TEXT, PRIMARY KEY (`pid`)) WITHOUT ROWID;"};
    const auto insertionSqlStmt {R"({"table":"processes","data":[{"pid":4,"name":"System"}, {"pid":3,"name":"cmd"}]})"};
    const auto updateSqlStmt {
        R"({"table":"processes","data":[{"pid":4,"name":"Cmd"}, {"pid":3,"name":"System"}, {"pid":5,"name":"powershell"}]})"};
...
{
    const auto sql {
        "CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `tid` BIGINT, PRIMARY KEY (`pid`)) WITHOUT ROWID;"};
    const auto handle {dbsync_create(HostType::AGENT, DbEngineType::SQLITE3, DATABASE_TEMP, sql)};
    ASSERT_NE(nullptr, handle);
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":4,"name":"System", "tid":100})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":5,"name":"System", "tid":101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":6,"name":"System", "tid":102})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(MODIFIED, nlohmann::json::parse(R"({"name":"System","pid":4,"tid":101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(MODIFIED, nlohmann::json::parse(R"({"pid":4,"name":"Systemmm","tid":105})")))
        .Times(1);
...
TEST_F(DBSyncTest, syncRowInsertAndModifiedWithOldData)
{
    ...
    EXPECT_CALL(
        wrapper,
        callbackMock(MODIFIED,
                     nlohmann::json::parse(R"({"new":{"name":"System","pid":4,"tid":101},"old":{"pid":4,"tid":100}})")))
        .Times(1);
    EXPECT_CALL(
        wrapper,
        callbackMock(MODIFIED,
                     nlohmann::json::parse(
                         R"({"new":{"name":"Systemmm","pid":4,"tid":105},"old":{"name":"System","pid":4,"tid":101}})")))
        .Times(1);

    auto insertionQuery1 = InsertQuery::builder()
                               .table("processes")
    ...
    auto updateQuery1 = SyncRowQuery::builder()
                            .table("processes")
                            .returnOldData()
                            .data(nlohmann::json::parse(R"({"pid":4,"name":"System", "tid":101})"));
    auto updateQuery2 = SyncRowQuery::builder()
                            .table("processes")
                            .returnOldData()
...
TEST_F(DBSyncTest, syncRowIgnoreFields)
{
    ...
    auto insertionQuery = InsertQuery::builder()
                              .table("processes")
                              .data(nlohmann::json::parse(R"({"pid":4,"name":"System", "tid":100})"))
                              .data(nlohmann::json::parse(R"({"pid":5,"name":"System", "tid":101})"))
                              .data(nlohmann::json::parse(R"({"pid":6,"name":"System", "tid":102})"));
    ...
    auto updateQuery2 = SyncRowQuery::builder()
                            ...
                            .ignoreColumn("name")
                            .data(nlohmann::json::parse(R"({"pid":4,"name":"Systemmm", "tid":105})"));
    auto updateQuery3 = SyncRowQuery::builder()
                            .table("processes")
                            .ignoreColumn("tid")
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":6,"name":"System","tid":102})")))
        .Times(1);
    EXPECT_CALL(wrapper,
                callbackMock(MODIFIED, nlohmann::json::parse(R"({"pid":4, "name":"SystemIsDown", "tid":106})")))
        .Times(1);
...
TEST_F(DBSyncTest, selectRowsDataAllNoFilter)
{
    ...
    const auto sql {"CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `tid` UNSIGNED BIGINT,`cpu_percentage` DOUBLE, "
    ...
    const auto insertionSqlStmt {
        R"({"table":"processes","data":[{"pid":4,"name":"System1", "tid":100, "cpu_percentage":10.7},
    ...
    EXPECT_CALL(wrapper,
                callbackMock(SELECTED,
                             nlohmann::json::parse(R"({"pid":4,"name":"System1", "tid":100, "cpu_percentage":10.7})")))
        .Times(1);
    EXPECT_CALL(
        wrapper,
        callbackMock(SELECTED,
                     nlohmann::json::parse(R"({"pid":115,"name":"System2", "tid":101, "cpu_percentage":55.4})")))
        .Times(1);
    EXPECT_CALL(
        wrapper,
        callbackMock(SELECTED,
                     nlohmann::json::parse(R"({"pid":120,"name":"System3", "tid":101, "cpu_percentage":22.1})")))
        .Times(1);
    EXPECT_CALL(
        wrapper,
        callbackMock(SELECTED,
                     nlohmann::json::parse(R"({"pid":125,"name":"System3", "tid":102, "cpu_percentage":90.3})")))
        .Times(1);
    EXPECT_CALL(
        wrapper,
        callbackMock(SELECTED,
...
TEST_F(DBSyncTest, selectRowsDataAllFilterPidOr)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(SELECTED, nlohmann::json::parse(R"({"pid":120,"name":"System3", "tid":101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(SELECTED, nlohmann::json::parse(R"({"pid":300,"name":"System5", "tid":102})")))
        .Times(1);
...
TEST_F(DBSyncTest, selectInnerJoin)
{
    ...
    const auto insertPidsSqlStmt {R"({"table":"processes","data":[{"pid":4,"name":"System1", "fid":100},
                                                                  ...
                                                                  {"pid":225,"name":"System3", "fid":102}]})"}; // Insert
                                                                                                                // pids
...
TEST_F(DBSyncTest, deleteSingleAndComposedData)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":6,"name":"System", "tid":102})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":7,"name":"System", "tid":103})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":8,"name":"System", "tid":104})")))
        .Times(1);
...
TEST_F(DBSyncTest, deleteRowsByFilter)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":4,"name":"System", "tid":100})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":5,"name":"User1", "tid":101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":6,"name":"User2", "tid":102})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":7,"name":"User3", "tid":103})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"pid":8,"name":"User4", "tid":104})")))
        .Times(1);
...
TEST_F(DBSyncTest, selectCountCPP)
{
    ...
    ResultCallbackData selectCallbackData {[&wrapper](ReturnTypeCallback type, const nlohmann::json& jsonResult)
                                           {
...
TEST_F(DBSyncTest, createTxnCPP)
{
    ...
    ResultCallbackData callbackData {[&wrapper](ReturnTypeCallback type, const nlohmann::json& jsonResult)
                                     {
                                         wrapper.callbackMock(type, jsonResult);
                                     }};
    ...
    EXPECT_NO_THROW(
        dbSyncTxn = std::make_unique<DBSyncTxn>(dbSync->handle(), nlohmann::json::parse(tables), 0, 100, callbackData));
...
TEST_F(DBSyncTest, createTxnCPP1)
{
    ...
    std::unique_ptr<DBSyncTxn> dbSyncTxn;
    EXPECT_NO_THROW(dbSyncTxn = std::make_unique<DBSyncTxn>(
                        dbSync->handle(), nlohmann::json::parse(tables), 0, 4096, callbackData));
...
{
    const auto sql {
        "CREATE TABLE processes(`pid` BIGINT, `name` TEXT, `time` BIGINT, PRIMARY KEY (`pid`, `time`)) WITHOUT ROWID;"};
    const auto tables {R"({"table": "processes"})"};
    const std::unique_ptr<DummyContext> dummyCtx {std::make_unique<DummyContext>()};
    std::unique_ptr<DBSync> dbSync;
    ...
    CallbackMock wrapper;
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4, "time":100100})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"time":100101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"name":"System","pid":4,"time":100100})")))
        .Times(1);
...
TEST_F(DBSyncTest, createTxnCPP3)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"time":100101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"pid":4,"time":100100,"name":"System"})")))
        .Times(1);
...
TEST_F(DBSyncTest, dbsyncAddTableRelationshipCPP)
{
    ...
    CallbackMock wrapper;
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"tid":100})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":5,"tid":101})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":6,"tid":102})")))
        .Times(1);
...
TEST(QueryBuilder, selectInsertDeleteQuery)
{
    ...
    auto insertQuery {InsertQuery::builder()
                          .table("processes")
    ...
    auto deleteQuery {DeleteQuery::builder().table("processes").data({{"pid", 6}}).rowFilter("").build()};
...
{
    const auto sql {"CREATE TABLE processes(`pid` BIGINT, `name` TEXT, PRIMARY KEY (`pid`)) WITHOUT ROWID;"};
    const auto insertionSqlStmt1 {
        R"({"table":"processes","data":[{"pid":4,"name":"System"}, {"pid":3,"name":"cmd"}]})"};
...
TEST_F(DBSyncTest, createTxnWithMaxRowsCPP)
{
    ...
    EXPECT_CALL(
        wrapper,
        callbackMock(MAX_ROWS,
                     nlohmann::json::parse(
                         R"({"data":[{"name":"Guake","pid":7},{"name":"Guake2","pid":8}],"table":"processes"})")))
        .Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"name":"System","pid":4})"))).Times(1);
...
TEST_F(DBSyncTest, createTxnAtomicOperation)
{
    ...
    const auto insertionSqlStmt1 {
        R"({"table":"processes","data":[{"pid":4,"name":"System", "time":100100}]})"}; // Insert
    std::unique_ptr<DBSyncTxn> dbSyncTxn;
    EXPECT_NO_THROW(
        dbSyncTxn = std::make_unique<DBSyncTxn>(dbSync->handle(), nlohmann::json::parse(tables), 0, 100, callbackData));
...
TEST_F(DBSyncTest, TestUpgrade)
{
    ...
    dbSync->insertData(nlohmann::json::parse(
        R"({"table":"simple_test","data":[{"name":"test1","value":1,"new_column":"new_value"}]})"));
    ...
    CallbackMock wrapper;
    EXPECT_CALL(wrapper,
                callbackMock(SELECTED, nlohmann::json::parse(R"({"name":"test1","value":1,"new_column":"new_value"})")))
        .Times(1);
