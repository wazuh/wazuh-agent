...
{
    return pSvc->ExecQuery(bstr_t("WQL"),
...
HRESULT ComHelper::CreateUpdateSearcher(IUpdateSearcher*& pUpdateSearcher)
{
    return CoCreateInstance(
        CLSID_UpdateSearcher, NULL, CLSCTX_INPROC_SERVER, IID_IUpdateSearcher, (LPVOID*)&pUpdateSearcher);
}
...
std::string BstrToString(BSTR bstr)
{
    ...
    int utf8_length = WideCharToMultiByte(CP_UTF8, 0, bstr, SysStringLen(bstr), nullptr, 0, nullptr, nullptr);
    if (utf8_length == 0)
    {
        return "";
    }
    ...
    std::vector<char> utf8_buffer(utf8_length + 1);

    WideCharToMultiByte(CP_UTF8, 0, bstr, SysStringLen(bstr), utf8_buffer.data(), utf8_length, nullptr, nullptr);
